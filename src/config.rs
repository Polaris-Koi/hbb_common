...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "kcbpmbf070317".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["a.kcbpmbf.com"];
pub const RS_PUB_KEY: &str = "xEhgCa6mpPbB4zWpNZ0XdJXVbDoouYlpjFK0WrHukEc=";
